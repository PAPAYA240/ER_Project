...
namespace Google.Protobuf.Protocol {
    ...
    static ProtocolReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bnZUeXBlGAIgASgOMhEuUHJvdG9jb2wuRW52VHlwZSJHChBDX1RhcmdldGlu",
            "Z1NraWxsEhAKCG9iamVjdElkGAEgASgFEg8KB2tleUNvZGUYAiABKAUSEAoI",
            ...
            "Ih4KDlNfT2NjdXB5QmVhY29uEgwKBHRlYW0YASABKAUiMgoSU19DaGFuZ2VC",
            "ZWFjb25UaW1lEg4KBmJlYWNvbhgBIAEoBRIMCgR0aW1lGAIgASgFIiwKDVNf",
            "Q2hhbmdlU2NvcmUSDAoEdGVhbRgBIAEoBRINCgVzY29yZRgCIAEoBSIdCgpT",
            "X0dhbWVPdmVyEg8KB3dpblRlYW0YASABKAUiYAoMUG9zaXRpb25JbmZvEiYK",
            "BXN0YXRlGAEgASgOMhcuUHJvdG9jb2wuQ3JlYXR1cmVTdGF0ZRIMCgRwb3NY",
            "GAIgASgCEgwKBHBvc1kYAyABKAISDAoEcG9zWhgEIAEoAiI+CgxSb3RhdGlv",
            "bkluZm8SCgoCcXgYASABKAISCgoCcXkYAiABKAISCgoCcXoYAyABKAISCgoC",
            "cXcYBCABKAIi9QEKCFN0YXRJbmZvEg4KBmF0dGFjaxgBIAEoAhIPCgdkZWZl",
            ...
            "KAUSDQoFbGV2ZWwYDSABKAUSDAoEaGVhbBgOIAEoBSJ8CgpQbGF5ZXJJbmZv",
            "EikKCGNoYXJUeXBlGAEgASgOMhcuUHJvdG9jb2wuQ2hhcmFjdGVyVHlwZRIT",
            "Cgtza2lsbFBvaW50cxgCIAEoBRIMCgR0ZWFtGAMgASgFEiAKBndlYXBvbhgE",
            "IAEoDjIQLlByb3RvY29sLldlYXBvbiI5CgtNb25zdGVySW5mbxIqCgttb25z",
            "dGVyVHlwZRgBIAEoDjIVLlByb3RvY29sLk1vbnN0ZXJUeXBlIoACCgdFbnZJ",
            ...
            "IAEoAhISCgphdHRhY2tlcklkGAQgASgFIq4CCgpPYmplY3RJbmZvEhAKCG9i",
            ...
            "b0gAEiAKA2VudhgIIAEoCzIRLlByb3RvY29sLkVudkluZm9IAEIUChJvYmpl",
            "Y3RTcGVjaWZpY0RhdGEisQEKE1BpY2tTY2VuZVBsYXllckluZm8SDwoHcGlj",
            "a0lkeBgBIAEoBRIQCgh1c2VyTmFtZRgCIAEoCRIpCghjaGFyVHlwZRgDIAEo",
            "DjIXLlByb3RvY29sLkNoYXJhY3RlclR5cGUSJgoJdHJhaXRUeXBlGAQgASgO",
            "MhMuUHJvdG9jb2wuVHJhaXRUeXBlEiQKCndlYXBvblR5cGUYBSABKA4yEC5Q",
            "cm90b2NvbC5XZWFwb24iJwoIQW5pbUluZm8SDAoEbmFtZRgBIAEoCRINCgVy",
            "YXRpbxgCIAEoAiJPChFXZWFwb25NYXN0ZXJ5SW5mbxITCgthdHRhY2tTcGVl",
            ...
            "TGV2ZWwYGyABKAIiHAoIQ19BdHRhY2sSEAoIdGFyZ2V0SWQYASABKAUiYAoP",
            "Q19TZXRNb3ZlVGFyZ2V0EhAKCGlzR3JvdW5kGAEgASgIEhAKCHRhcmdldElk",
            "GAIgASgFEikKCXRhcmdldFBvcxgDIAEoCzIWLlByb3RvY29sLlBvc2l0aW9u",
            "SW5mbyIuCgZDX1N0b3ASJAoGcmVhc29uGAEgASgOMhQuUHJvdG9jb2wuU3Rv",
            "cFJlYXNvbiI6CgZTX1N0b3ASCgoCaWQYASABKAUSJAoGcmVhc29uGAIgASgO",
            "MhQuUHJvdG9jb2wuU3RvcFJlYXNvbiJsCg9TX1NldE1vdmVUYXJnZXQSCgoC",
            "aWQYASABKAUSEAoIaXNHcm91bmQYAiABKAgSEAoIdGFyZ2V0SWQYAyABKAUS",
            "KQoJdGFyZ2V0UG9zGAQgASgLMhYuUHJvdG9jb2wuUG9zaXRpb25JbmZvIqQB",
            "Cg5TX1NraWxsQ29uZmlybRIQCghvYmplY3RJZBgBIAEoBRIOCgZjYW5Vc2UY",
            "AiABKAgSEAoIc2tpbGxLZXkYAyABKAUSJAoIY29zdEluZm8YBCABKAsyEi5Q",
            "cm90b2NvbC5Db3N0SW5mbxIQCgh0YXJnZXRJZBgFIAEoBRImCgh2YXJpYW50",
            "cxgGIAEoDjIULlByb3RvY29sLlZhcmlhbnRLZXkimwIKDVNfU2tpbGxNb3Rp",
            "b24SEAoIb2JqZWN0SWQYASABKAUSJwoEdHlwZRgCIAEoDjIZLlByb3RvY29s",
            "LlNraWxsTW90aW9uVHlwZRIOCgZzdGFydFgYAyABKAISDgoGc3RhcnRZGAQg",
            "ASgCEg4KBnN0YXJ0WhgFIAEoAhIMCgRlbmRYGAYgASgCEgwKBGVuZFkYByAB",
            "KAISDAoEZW5kWhgIIAEoAhIQCghkdXJhdGlvbhgJIAEoAhIMCgRhbmltGAog",
            "ASgJEg8KB2N1cnZlSWQYCyABKAkSFwoPc2VydmVyQ29sbGlzaW9uGAwgASgI",
            "EhgKEGF1dGhvcml0YXRpdmVFbmQYDSABKAgSEQoJa2V5ZnJhbWVzGA4gAygC",
            "IlIKDENfU2tpbGxJbnB1dBIQCghza2lsbEtleRgBIAEoBRIQCgh0YXJnZXRJ",
            "ZBgCIAEoBRIOCgZtb3VzZVgYAyABKAISDgoGbW91c2VaGAQgASgCIvcBChdD",
            "X1NraWxsQ29sbGlzaW9uUHJvcG9zZRIQCghza2lsbEtleRgBIAEoBRILCgNz",
            "ZXEYAiABKAUSJAoEbW9kZRgDIAEoDjIWLlByb3RvY29sLlByb3Bvc2FsTW9k",
            "ZRITCgtlbmRCbG9ja2VkWBgEIAEoAhITCgtlbmRCbG9ja2VkWhgFIAEoAhIQ",
            "CghlbmRQYXNzWBgGIAEoAhIQCghlbmRQYXNzWhgHIAEoAhIWCg5iZWhpbmRC",
            "bG9ja2VkWBgIIAEoAhIWCg5iZWhpbmRCbG9ja2VkWhgJIAEoAhIZChFjYW5k",
            "aWRhdGVUYXJnZXRJZBgKIAEoBSIYCgZDX1Jlc3QSDgoGaXNSZXN0GAEgASgI",
            "IlgKClNfTW92ZVN5bmMSEAoIb2JqZWN0SWQYASABKAUSKQoJdGFyZ2V0UG9z",
            "GAIgASgLMhYuUHJvdG9jb2wuUG9zaXRpb25JbmZvEg0KBXNwZWVkGAMgASgC",
            ...
            "RW5kQXR0YWNrGAIgASgIIkwKE0NoYW5nZUludmVudG9yeUluZm8SDgoGaXRl",
            "bUlkGAEgASgFEhYKDmludmVudG9yeUluZGV4GAIgASgFEg0KBWNvdW50GAMg",
            "ASgFIkcKB0tEQUluZm8SEAoIb2JqZWN0SWQYASABKAUSDAoEa2lsbBgCIAEo",
            "BRINCgVkZWF0aBgDIAEoBRINCgVhc2lzdBgEIAEoBSrtCQoFTXNnSWQSEAoM",
            "Q19FTlRFUl9HQU1FEAASEAoMU19FTlRFUl9HQU1FEAESEAoMU19MRUFWRV9H",
            ...
            "SxASEhAKDFNfTEVBVkVfUElDSxATEgoKBkNfUElORxAUEhUKEVNfVklTSUJM",
            "RV9PQkpFQ1RTEBUSDgoKU19MRVZFTF9VUBAWEgsKB0NfUkVBRFkQFxIICgRT",
            ...
            "R0VfU1RBVBAjEhUKEUNfVEFSR0VUSU5HX1NLSUxMECQSFgoSU19DSEFOR0Vf",
            ...
            "CgdDX0RFQVRIEDwSEwoPU19PQ0NVUFlfQkVBQ09OED8SGAoUU19DSEFOR0Vf",
            "QkVBQ09OX1RJTUUQQBISCg5TX0NIQU5HRV9TQ09SRRBBEg8KC1NfR0FNRV9P",
            "VkVSEEISFgoSU19DSEFOR0VfVFJBTlNGT1JNEEMSEwoPU19UQVJHRVRfQ0hB",
            "TkdFEEQSEwoPQ19TS0lMTF9QUkVQQVJFEEUSEgoOQ19TS0lMTF9DQU5DRUwQ",
            "RhITCg9DX1NLSUxMX0VYRUNVVEUQRxILCgdTX1NOQVJFEEgqagoNQ3JlYXR1",
            "cmVTdGF0ZRIICgRJRExFEAASCgoGTU9WSU5HEAESCgoGQVRUQUNLEAISCQoF",
            "U0tJTEwQAxIICgRERUFEEAQSCAoEUkVTVBAFEgwKCENIQVJHSU5HEAYSCgoG",
            "QVBQRUFSEAcqTAoOU2tpbGxJbnB1dFR5cGUSCwoHSW5zdGFudBAAEgoKBkNo",
            "YXJnZRABEg0KCVBsYWNlbWVudBACEhIKDkNoYXJnZUFuZFBsYWNlEAMqVAoO",
            "R2FtZU9iamVjdFR5cGUSCAoETk9ORRAAEgoKBlBMQVlFUhABEgsKB01PTlNU",
            "RVIQAhIOCgpQUk9KRUNUSUxFEAMSDwoLRU5WSVJPTk1FTlQQBCp+CgdFbnZU",
            "eXBlEgwKCEVOVl9OT05FEAASDQoJSEVBTF9QQUNLEAESFQoRREVWSUNFX1NQ",
            "QVdOUE9JTlQQAhIaChZBQ0NCT1VOREFSWV9TUEFXTlBPSU5UEAMSFgoSQkFS",
            "UklFUl9TUEFXTlBPSU5UEAQSCwoHVFVSQklORRAFKnUKCVNraWxsVHlwZRIO",
            "CgpTS0lMTF9OT05FEAASDgoKU0tJTExfQVVUTxABEhQKEFNLSUxMX1BST0pF",
            "Q1RJTEUQAhIQCgxTS0lMTF9TVEFUSUMQAxIPCgtTS0lMTF9UUkFDSxAEEg8K",
            "C1NLSUxMX1BPSU5UEAUq/wEKDE1vbnN0ZXJTa2lsbBILCgdNU19OT05FEAAS",
            "DgoKTVNfQVRUQUNLMRABEg4KCk1TX0FUVEFDSzIQAhINCglNU19TS0lMTDEQ",
            "AxINCglNU19TS0lMTDIQBBINCglNU19TS0lMTDMQBRIUChBNU19EUk9ORV9B",
            "VFRBQ0sxEAYSFAoQTVNfRFJPTkVfQVRUQUNLMhAHEhQKEE1TX0dBTU1BX0FU",
            "VEFDSzEQCBITCg9NU19HQU1NQV9TS0lMTDEQCRITCg9NU19HQU1NQV9TS0lM",
            "TDIQChITCg9NU19HQU1NQV9TS0lMTDMQCxIUChBNU19UVVJSRVRfQVRUQUNL",
            "EAwqNgoIQW5pbVR5cGUSCAoEUExBWRAAEgsKB1RSSUdHRVIQARIICgRCT09M",
            "EAISCQoFRkxPQVQQAypgCg1DaGFyYWN0ZXJUeXBlEhIKDkNIQVJBQ1RFUl9O",
            "T05FEAASCQoFUk9aWkkQARIICgRZVUtJEAISCwoHSFlVTldPTxADEgsKB0FC",
            "SUdBSUwQBBIMCghUSEVPRE9SRRAFKlcKC01vbnN0ZXJUeXBlEhAKDE1PTlNU",
            "RVJfTk9ORRAAEgkKBUFMUEhBEAESCQoFT01FR0EQAhIJCgVEUk9ORRADEgkK",
            "BUdBTU1BEAQSCgoGVFVSUkVUEAUqxgIKBldlYXBvbhIPCgtXRUFQT05fTk9O",
            "RRAAEgoKBkRBR0dFUhABEhIKDlRXT19IQU5EX1NXT1JEEAISBwoDQVhFEAMS",
            "DwoLRFVBTF9TV09SRFMQBBIKCgZQSVNUT0wQBRIRCg1BU1NBVUxUX1JJRkxF",
            "EAYSEAoMU05JUEVSX1JJRkxFEAcSCgoGUkFQSUVSEAgSCQoFU1BFQVIQCRIK",
            "CgZIQU1NRVIQChIHCgNCQVQQCxIJCgVUSFJPVxAMEgwKCFNIVVJJS0VOEA0S",
            "BwoDQk9XEA4SDAoIQ1JPU1NCT1cQDxIJCgVHTE9WRRAQEgkKBVRPTkZBEBES",
            "CgoGR1VJVEFSEBISDAoITlVOQ0hBS1UQExIICgRXSElQEBQSCgoGQ0FNRVJB",
            "EBUSCgoGQVJDQU5BEBYSEgoOVl9GX1BST1NUSEVUSUMQFypXCgpTa2lsbFNo",
            "YXBlEg4KClNIQVBFX05PTkUQABIKCgZDSVJDTEUQARIHCgNSQVkQAhINCglS",
            "RUNUQU5HTEUQAxIKCgZTRUNUT1IQBBIJCgVQT0lOVBAFKsICCglUcmFpdFR5",
            "cGUSFgoSRlJBSUxUWV9JTkZMSUNUSU9OEAASFgoSVkFNUElSSUNfQkxPT0RM",
            "SU5FEAESDgoKQURSRU5BTElORRACEg8KC0FDQ0VMRVJBVEVSEAMSEgoOU1RF",
            "TExBUl9DSEFSR0UQBBIPCgtHSE9TVF9MSUdIVBAFEg4KClJFRF9TUFJJVEUQ",
            "BhIUChBTSVBIT05fTUFFTFNUT1JNEAcSEQoNRElBTU9ORF9TSEFSRBAIEgwK",
            "CElST05DTEFEEAkSEgoOSEVBVllfS05FRVBBRFMQChIWChJCSVRURVJfUkVU",
            "UklCVVRJT04QCxISCg5IRUFMSU5HX0ZBQ1RPUhAMEhcKE0FNUExJRklDQVRJ",
            "T05fRFJPTkUQDRIRCg1IRUFMSU5HX0RST05FEA4SDAoIU0VOVElORUwQDypa",
            "Cg1FcXVpcEl0ZW1UeXBlEgoKBldFQVBPThAAEggKBEJPRFkQARIICgRIRUFE",
            "EAISBwoDQVJNEAMSBwoDTEVHEAQSFwoTRVFVSVBfSVRFTV9UWVBFX0VORBAF",
            "KmgKCUl0ZW1HcmFkZRIKCgZDT01NT04QABIMCghVTkNPTU1PThABEggKBFJB",
            "UkUQAhIICgRFUElDEAMSDQoJTEVHRU5EQVJZEAQSCgoGTVlUSElDEAUSEgoO",
            "SVRFTV9HUkFERV9FTkQQBiouCgpTdG9wUmVhc29uEgwKCFNUT1BfQUxMEAAS",
            "EgoOU1RPUF9NT1ZFX09OTFkQASorCg9Ta2lsbE1vdGlvblR5cGUSCQoFYWdl",
            "bnQQABINCgl0cmFuc2Zvcm0QASo3CgxQcm9wb3NhbE1vZGUSCAoETm9uZRAA",
            "Eg4KClNpbmdsZVNob3QQARINCglTdHJlYW1pbmcQAio1CgpWYXJpYW50S2V5",
  ...
  public enum MsgId {
    ...
    [pbr::OriginalName("C_SKILL_PREPARE")] CSkillPrepare = 69,
    [pbr::OriginalName("C_SKILL_CANCEL")] CSkillCancel = 70,
    [pbr::OriginalName("C_SKILL_EXECUTE")] CSkillExecute = 71,
    [pbr::OriginalName("S_SNARE")] SSnare = 72,
  }
