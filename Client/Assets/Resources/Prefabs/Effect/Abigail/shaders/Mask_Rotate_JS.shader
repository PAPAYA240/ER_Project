    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                // MainTex 알파가 없는 경우, 검은색을 0으로 처리
                float mainAlpha = max(max(mainCol.r, mainCol.g), mainCol.b);
                ...
                // 최종 알파
                float alpha = mainAlpha * maskCol.a * _Color.a;
